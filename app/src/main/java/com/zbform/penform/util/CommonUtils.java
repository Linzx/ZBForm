...
public class CommonUtils {
     ...
     *         C 0~107
     *
     *         @params addressKey 是否地址作为map key
     *         @params address  表单的起始地址
     *         @params pages 表单的页数
     */
    public static HashMap<String, String> findValidateAddress(boolean addressKey, String address, int pages) {
        HashMap<String, String> valAddress = new HashMap<String, String>();
        ...
        try {
            ...
            for (int i = 1; i < pages; i++) {
                ...
                if (addressKey) {
                    valAddress.put(nextAddress, String.valueOf(i + 1));
                } else {
                    valAddress.put(String.valueOf(i + 1), nextAddress);
                }
    ...
    public static String getDeviceInfo() {
        ...
        builder.append("APP.VERSION = " + getAPPVersionCode(ZBformApplication.context) + "\n");
        builder.append("\n" + "log:" + "\n");
