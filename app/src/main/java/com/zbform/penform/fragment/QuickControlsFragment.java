...
public class QuickControlsFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPlayPause.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (MusicPlayer.getQueueSize() == 0) {
                    Toast.makeText(ZBformApplication.context, getResources().getString(R.string.queue_is_empty),
                            Toast.LENGTH_SHORT).show();
                } else {
                    HandlerUtil.getInstance(ZBformApplication.context).postDelayed(new Runnable() {
                        @Override
                        public void run() {
        ...
        rootView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Intent intent = new Intent(ZBformApplication.context, PlayingActivity.class);
//                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//                ZBformApplication.context.startActivity(intent);
            }
        });
    ...
    public void updateNowplayingCard() {
        ...
        mArtist.setText(MusicPlayer.getArtistName());
            ...
            Uri uri = null;
            try{
                Log.d("Darren","AlbumPath:" + MusicPlayer.getAlbumPath());
                uri = Uri.parse(MusicPlayer.getAlbumPath());
            }catch (NullPointerException e1){
                Log.d("Darren","null point");
            }catch (Exception e){
                e.printStackTrace();
                Log.d("Darren","Uri is null");
            }
            if (uri != null) {
