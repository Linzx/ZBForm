...
import com.zbform.penform.activity.ArtistDetailActivity;
import com.zbform.penform.adapter.MusicFlowAdapter;
import com.zbform.penform.adapter.OverFlowAdapter;
import com.zbform.penform.adapter.OverFlowItem;
import com.zbform.penform.dialog.AddNetPlaylistDialog;
import com.zbform.penform.downmusic.Down;
import com.zbform.penform.handler.HandlerUtil;
import com.zbform.penform.info.MusicInfo;
import com.zbform.penform.json.SearchAlbumInfo;
import com.zbform.penform.json.SearchArtistInfo;
import com.zbform.penform.net.BMA;
import com.zbform.penform.net.HttpUtil;
import com.zbform.penform.service.MusicPlayer;
import com.zbform.penform.widget.DividerItemDecoration;
                        ...
                        new AlertDialog.Builder(mContext).setTitle("要下载音乐吗").
                                setPositiveButton(mContext.getString(R.string.sure), new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        Down.downMusic(ZBformApplication.context, adapterMusicInfo.songId + "", adapterMusicInfo.musicName, adapterMusicInfo.artist);
                                        dialog.dismiss();
                                    }
                                }).
                                ...
                                protected Void doInBackground(Void... params) {
                                    ...
                                    try {
                                        ...
                                        for (JsonElement o : artistArray) {
                                            SearchArtistInfo artistInfo = ZBformApplication.gsonInstance().fromJson(o, SearchArtistInfo.class);
...
//                                        }
                                        ...
                                        for (JsonElement o : albumArray) {
                                            SearchAlbumInfo albumInfo = ZBformApplication.gsonInstance().fromJson(o, SearchAlbumInfo.class);
