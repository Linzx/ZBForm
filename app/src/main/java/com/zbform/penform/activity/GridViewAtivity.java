...
public class GridViewAtivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_fromlist);
        ptrClassicFrameLayout = (PtrClassicFrameLayout) this.findViewById(R.id.form_grid_view_frame);
//        mGridView = (GridViewWithHeaderAndFooter) this.findViewById(R.id.form_grid_view);
        initData();
    }
