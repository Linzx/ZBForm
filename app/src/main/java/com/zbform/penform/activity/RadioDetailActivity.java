...
import com.zbform.penform.json.RadioInfo;
                ...
                new AlertDialog.Builder(RadioDetailActivity.this).setTitle("要下载音乐吗").
                        setPositiveButton(RadioDetailActivity.this.getString(R.string.sure), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                int len = mList.size();
                                for (int i = 0; i < len; i++) {
                                    Down.downMusic(ZBformApplication.context, mList.get(i).getSong_id(), mList.get(i).getSong_name(), artistName);
                                }
                                dialog.dismiss();
                            }
                        }).
        ...
        protected Void doInBackground(final Void... unused) {
            try {
                ...
                for (int i = 0; i < musicCount; i++) {
                    RadioInfo geDanGeInfo = ZBformApplication.gsonInstance().fromJson(jsonArray.get(i), RadioInfo.class);
