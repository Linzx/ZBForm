...
import com.zbform.penform.activity.SkillSummaryActivity;
import com.zbform.penform.banner.Banner;
import com.zbform.penform.banner.BannerHttpUtils;
import com.zbform.penform.banner.GlideImageLoader;
import com.zbform.penform.banner.JsonUtils;
import com.zbform.penform.info.URLUtils;
import com.google.gson.JsonArray;
import com.google.gson.JsonObject;
import com.zbform.penform.R;
import com.zbform.penform.activity.AlbumsDetailActivity;
import com.zbform.penform.activity.NetItemChangeActivity;
import com.zbform.penform.activity.PlaylistActivity;
import com.zbform.penform.activity.RadioDetailActivity;
import com.zbform.penform.fragment.AttachFragment;
import com.zbform.penform.json.RecommendListNewAlbumInfo;
import com.zbform.penform.json.RecommendListRadioInfo;
import com.zbform.penform.json.RecommendListRecommendInfo;
...
//        mLoodView = (LoodView) mRecommendView.findViewById(R.id.loop_view);
        banner = mRecommendView.findViewById(R.id.banner);
        banner.setImageLoader(new GlideImageLoader());
        new MyAsyncTask1().execute(URLUtils.URL_PATH_JSON);
        if(!isDayFirst){
            mContent.addView(mRecommendView);
        }

        TintButton skills = mRecommendView.findViewById(R.id.skills);
        skills.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent intent = new Intent(mContext, SkillSummaryActivity.class);
                        mContext.startActivity(intent);

                    }
                }, 60);
                Log.d("Darren","click skills button");
            }
        });
    ...
    public class MyAsyncTask1 extends AsyncTask<String, Void, List<String>> {
        ...
        protected List<String> doInBackground(String... strings) {
            ...
            String urlString = BannerHttpUtils.sendPostMessage(strings[0], "utf-8");
            //    解析服务器端的json数据
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                try {
                    ...
                    for (int i = 0; i < 6; i++) {
                        mRecomendList.add(ZBformApplication.gsonInstance().fromJson(recommendArray.get(i), RecommendListRecommendInfo.class));
                        mNewAlbumsList.add(ZBformApplication.gsonInstance().fromJson(newAlbumArray.get(i), RecommendListNewAlbumInfo.class));
                        mRadioList.add(ZBformApplication.gsonInstance().fromJson(radioArray.get(i), RecommendListRadioInfo.class));
                    }
    ...
    class RecommendAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            ((ItemView) holder).itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Log.d("Darren","jump to playlistactivity from recommend");
