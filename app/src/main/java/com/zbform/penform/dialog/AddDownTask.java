...
public class AddDownTask extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = null;//inflater.inflate(R.layout.loading_dialog_fragment, container);
        SimpleDraweeView draweeView =null;// (SimpleDraweeView) view.findViewById(R.id.loding_circle);
    ...
    class LoadDownInfos extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            for (int j = 0; j < le; j++) {
                try {
                    JsonArray jsonArray = null;//HttpUtil.getResposeJsonObject(BMA.Song.songInfo(ids[j]).trim()).get("songurl")
