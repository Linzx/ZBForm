package com.zbform.penform.dialog;
...
import com.zbform.penform.fragment.AttachDialogFragment;
import com.zbform.penform.info.Playlist;
import com.zbform.penform.provider.PlaylistInfo;
import com.zbform.penform.provider.PlaylistsManager;
import com.zbform.penform.service.MusicTrack;
                    ...
                    public void onClick(View v) {
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                for (long id : musicId) {
                                    albumart = MusicUtils.getAlbumdata(ZBformApplication.context, id);
                                    if (albumart != null) {
                                        break;
                                    }
                                }
                                ...
                                for (int i = 0; i < musicId.length; i++) {
                                    playlistsManager.insert(ZBformApplication.context, editText.getText().hashCode(), musicId[i], i);
                                }
