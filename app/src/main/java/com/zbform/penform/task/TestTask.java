...
public class TestTask implements IZBformNetBeanCallBack {
	...
	public void execute(Context context) {
		mContext = context;
		String formListUri = ApiAddress.getFormImgUri(ZBformApplication.getmLoginUserId(),
				ZBformApplication.getmLoginUserKey(),"8341b2a9-7b72-4059-9822-ae77e6580c46",1);
	...
	public void onSuccess(ResponseInfo<String> responseInfo) {
		try {
			...
			Log.i("whd", "result img Gson!!=" + resultGson);
			Gson gson = new Gson();
