...
import com.zbform.penform.activity.DownActivity;
import com.zbform.penform.activity.PlaylistActivity;
import com.zbform.penform.activity.PlaylistManagerActivity;
//import com.zbform.penform.activity.RecentActivity;
import com.zbform.penform.activity.TabActivity;
        ...
        itemHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Log.d("Darren","jump into playlistactivity");
