...
/**
 */
public class ZBformApplication extends Application implements ThemeUtils.switchColor {
...
//        ZBformApplication application = (ZBformApplication) context.getApplicationContext();
